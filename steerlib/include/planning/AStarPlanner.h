	...
	*/
	class STEERLIB_API AStarPlannerNode{
		public:
			...
			AStarPlannerNode(Util::Point _point, double _g, double _f, float _px, float _py, float _pz)
			{
				f = _f;
				point = _point;
				g = _g;
	...
	class STEERLIB_API AStarPlanner{
		public:
			...
			*/
			...
			void getNeighbors(std::vector<SteerLib::AStarPlannerNode>& neighbors, SteerLib::AStarPlannerNode p, Util::Point goal);
		private:
